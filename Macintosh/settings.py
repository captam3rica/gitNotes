...
ADMINS = (
    ('Matt Wilson', 'jwils156@kennesaw.edu'),
    ('Ray Kerce', 'rkerce@kennesaw.edu')
)
...
# The order plugins (if they're able to be shown on that particular page) will be
# displayed in. If not listed here, will be listed alphabetically after.
...
# that group.
# Edit by jwils156 | All Machines Group
DEFAULT_MACHINE_GROUP_KEY = 'swcgg28dbk8scugwv6tlq2uwhn8u8fqxq5ho8kznprewv97gpek1tjgmr3bam0wmn7xf8lh8ft1e9wn87h7pyvseyqy6cp36ftw3b98dcysnq2vgjb49hm9i4mk8mo3a'
